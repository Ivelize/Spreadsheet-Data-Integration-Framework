...
public class RelativeSquaredError extends PerformanceMeasures {

	public RelativeSquaredError() {	
		this.mType = PerformanceErrorTypes.RELATIVE_SQUARED_ERROR;
	}
	...
	public float calc(float[][] predictedMatrix, float[][] observedMatrix, Set<SemanticMatrixCellIndex> indexesSet) {
		...
		logger.debug("relativeSquaredError: " + relativeSquaredError);
