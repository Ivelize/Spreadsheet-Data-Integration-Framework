 ...
 *
 */
public class _03VerticalPartitioningScenarioTest extends AbstractIntegrationTest {

	private static Logger logger = Logger.getLogger(_03VerticalPartitioningScenarioTest.class);
