 ...
 *
 */
public class _01HorizontalPartitioningScenarioTest extends AbstractIntegrationTest {

	private static Logger logger = Logger.getLogger(_01HorizontalPartitioningScenarioTest.class);
