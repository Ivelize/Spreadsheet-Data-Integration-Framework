...
DROP DATABASE IF EXISTS MondialCityProvinceCountryContinentAfricaNoRename ;

CREATE DATABASE MondialCityProvinceCountryContinentAfricaNoRename;

USE MondialCityProvinceCountryContinentAfricaNoRename;
