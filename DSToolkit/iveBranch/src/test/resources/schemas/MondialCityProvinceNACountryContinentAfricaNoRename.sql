...
DROP DATABASE IF EXISTS MondialCityProvinceNACountryContinentAfricaNoRename ;

CREATE DATABASE MondialCityProvinceNACountryContinentAfricaNoRename;

USE MondialCityProvinceNACountryContinentAfricaNoRename;
