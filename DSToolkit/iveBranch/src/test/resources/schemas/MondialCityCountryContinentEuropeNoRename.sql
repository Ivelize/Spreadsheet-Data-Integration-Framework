...
DROP DATABASE IF EXISTS MondialCityCountryContinentEuropeNoRename ;

CREATE DATABASE MondialCityCountryContinentEuropeNoRename;

USE MondialCityCountryContinentEuropeNoRename;
