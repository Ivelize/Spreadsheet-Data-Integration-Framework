...
DROP DATABASE IF EXISTS MondialCityProvinceNACountryContinentAfricaWithRename ;

CREATE DATABASE MondialCityProvinceNACountryContinentAfricaWithRename;

USE MondialCityProvinceNACountryContinentAfricaWithRename;
