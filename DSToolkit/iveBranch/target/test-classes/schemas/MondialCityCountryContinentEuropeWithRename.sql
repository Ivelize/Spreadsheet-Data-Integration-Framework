...
DROP DATABASE IF EXISTS MondialCityCountryContinentEuropeWithRename ;

CREATE DATABASE MondialCityCountryContinentEuropeWithRename;

USE MondialCityCountryContinentEuropeWithRename;
