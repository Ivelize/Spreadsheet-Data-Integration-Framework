...
DROP DATABASE IF EXISTS MondialCityProvinceCountryContinentEuropeWithRename ;

CREATE DATABASE MondialCityProvinceCountryContinentEuropeWithRename;

USE MondialCityProvinceCountryContinentEuropeWithRename;
...
(NameE VARCHAR(35),
 ...
 LongitudeE FLOAT,
 LatitudeE FLOAT,
 CONSTRAINT CityEKey PRIMARY KEY (NameE, CountryE, ProvinceE),
...
(NameE VARCHAR(35) NOT NULL,
 ...
 CapitalE VARCHAR(35),
 CapProvE VARCHAR(35),
 CONSTRAINT PrEKey PRIMARY KEY (NameE, CountryE),
 CONSTRAINT PrPopE CHECK (PopulationE >= 0),
 CONSTRAINT PrArE CHECK (AreaE >= 0))
ENGINE=InnoDB;
...
ALTER TABLE CityE
ADD CONSTRAINT CityProvinceEFK
FOREIGN KEY CityProvinceEFK (ProvinceE, CountryE)
REFERENCES ProvinceE(NameE, CountryE);

ALTER TABLE ProvinceE
ADD CONSTRAINT ProvinceCountryEFK
FOREIGN KEY ProvinceCountryEFK (CountryE)
