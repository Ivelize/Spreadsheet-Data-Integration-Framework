...
DROP DATABASE IF EXISTS MondialCityProvinceCountryContinentEuropeNoRename ;

CREATE DATABASE MondialCityProvinceCountryContinentEuropeNoRename;

USE MondialCityProvinceCountryContinentEuropeNoRename;
