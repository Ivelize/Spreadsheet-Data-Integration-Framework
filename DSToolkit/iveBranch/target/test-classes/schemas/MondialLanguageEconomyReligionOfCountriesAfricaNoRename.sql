...
DROP DATABASE IF EXISTS MondialLanguageEconomyReligionOfCountriesAfricaNoRename ;

CREATE DATABASE MondialLanguageEconomyReligionOfCountriesAfricaNoRename;

USE MondialLanguageEconomyReligionOfCountriesAfricaNoRename;
