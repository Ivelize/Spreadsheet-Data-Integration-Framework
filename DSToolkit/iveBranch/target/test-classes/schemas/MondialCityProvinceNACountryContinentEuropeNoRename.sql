...
DROP DATABASE IF EXISTS MondialCityProvinceNACountryContinentEuropeNoRename ;

CREATE DATABASE MondialCityProvinceNACountryContinentEuropeNoRename;

USE MondialCityProvinceNACountryContinentEuropeNoRename;
